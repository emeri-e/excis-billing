    ...
    class Meta:
        ...
        widgets = {
            ...
            "name": forms.TextInput(
                attrs={"class": "form-control", "placeholder": "US Dollar"}
            ),
...
class CountryForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            "name": forms.TextInput(
                attrs={"class": "form-control", "placeholder": "United States"}
            ),
            "code": forms.TextInput(
                attrs={
                    "class": "form-control",
...
class AccountForm(forms.ModelForm):
    ...
    new_currency_symbol = forms.CharField(
        ...
        required=False,
        widget=forms.TextInput(
            attrs={"class": "form-control", "placeholder": "e.g., KSh"}
        ),
    )
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields["customer"].queryset = Customer.objects.filter(is_active=True)
        self.fields["billing_cycle"].queryset = BillingCycle.objects.filter(
            is_active=True
        )
    ...
    def clean(self):
        ...
        if new_country_name and new_country_code:
            country, created = Country.objects.get_or_create(
                code=new_country_code.upper(), defaults={"name": new_country_name}
            )
